...
<body>
  ...
  <h4 style="color: black">PEDIDO NRO: {{ str_pad($quotation->number_order ?? $quotation->id, 6, "0", STR_PAD_LEFT)}}</h4>
...
<table style="width: 100%;">
  ...
  <tr>
    <th style="text-align: left; font-weight: normal; width: 79%; border-top-color: rgb(17, 9, 9); border-right-color: white; font-size: small;"><pre>Pedido</pre></th>

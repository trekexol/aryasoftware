...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row py-lg-2">
            <div class="col-md-6">
                <h2>Editar Tercer Sub Segmento</h2>
            </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="card">
                    <div class="card-body">
                        <form  method="POST"   action="{{ route('threesubsegments.update',$var->id) }}" enctype="multipart/form-data" >
                            @method('PATCH')
                            @csrf()
                                ...
                                <div class="form-group row">
                                    ...
                                    <select class="form-control" id="segment_id" name="segment_id">
                                        ...
                                        @else
                                            <div class="dropdown">
                                                @foreach($twosubsegments as $segment)
